...
public class CustomerResource {
    ...
    @LogActivity(value = "Get all customers")
    @Security
    ...
    public Response getCustomersByName(@QueryParam("name") String name) {
        ...
        if (!customersByName.isEmpty()) {
            logElapsedTime("Get customer by Name", startTime, endTime);
    ...
    public Response getCustomerById(@PathParam("id") int id) {
        ...
        if (customer != null) {
            logElapsedTime("Get customer by ID", startTime, endTime);
    ...
    public Response saveCustomer(Customer customer) {
        ...
        long endTime = System.currentTimeMillis();
        logElapsedTime("Save customer", startTime, endTime);
    ...
    public Response updateCustomer(@PathParam("id") int id, Customer customer) {
        ...
        long endTime = System.currentTimeMillis();
        logElapsedTime("Update customer", startTime, endTime);
    ...
    public Response deleteCustomer(@PathParam("id") int id) {
        ...
        long endTime = System.currentTimeMillis();
        logElapsedTime("Delete customer", startTime, endTime);
